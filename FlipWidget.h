...
public:
    ...
    */
    QFlipWidget( QRectF bounds, QPixmap front, QPixmap back, bool useOpenGL = false, QWidget* parent = NULL );
    ...
    */
    bool isOpenGL();
    /**
        Obtiene el valor de un flipwidget
    */
    int getValor();
    /**
        Establece el valor de un flipwidget
    */
    void setValor(int v);
    /**
        Establece las imagenes de frente y fondo de un FlipWidget
    */
    void setPixmap(bool frente, QPixmap P);
...
signals:
    /**
     Senhal para cuando se de click izquierdo
     */
    void clicked();
...
private slots:
    ...
    */
    ...
    /**
     Emitir senhal cliked
     */
    void emitClicked();
    /**
        Activarse cuando se termine de voltear la imagen
      */
    void endFlipping();
...
private:
    ...
    /**
     indica si el widget se esta volteando

     */
    bool flipping;

    /**
     Valor con el que se identifican las particulas
     */
    int Valor;
